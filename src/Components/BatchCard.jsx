...
// export default function BatchCard({ batch, onSelect, onMap, isSelected }) {
//   return (
//     <article
//       className={`flex items-center gap-6 bg-white p-6 rounded-xl border ${isSelected ? "ring-2 ring-emerald-200" : "border-transparent"} shadow-sm`}
//       onClick={onSelect}
//     >
...
//             <div className="text-sm text-slate-500">Batch ID: <span className="text-slate-600">{batch.id}</span></div>
//           </div>
...
//           >
//             <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none"><path d="M4 21l7-3 7 3V8l-7-3-7 3v13z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
//             View Details
//           </button>
